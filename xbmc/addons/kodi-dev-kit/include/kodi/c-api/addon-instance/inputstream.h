...
extern "C"
{
  ...
  struct INPUTSTREAM_INFO
  {
    ...
    char m_name[INPUTSTREAM_MAX_STRING_NAME_SIZE]; /*!< @brief (optinal) name of the stream, \0 for
                                                      default handling */
    char m_codecName[INPUTSTREAM_MAX_STRING_CODEC_SIZE]; /*!< @brief (required) name of codec
                                                            according to ffmpeg */
    char m_codecInternalName[INPUTSTREAM_MAX_STRING_CODEC_SIZE]; /*!< @brief (optional) internal
                                                                    name of codec (selectionstream
                                                                    info) */
    ...
    char m_language[INPUTSTREAM_MAX_STRING_LANGUAGE_SIZE]; /*!< @brief RFC 5646 language code (empty
                                                              string if undefined) */
    ...
    struct INPUTSTREAM_MASTERING_METADATA*
        m_masteringMetadata; /*!< @brief mastering static Metadata */
    struct INPUTSTREAM_CONTENTLIGHT_METADATA*
